...
class DatabaseMigrator:
    ...
    def verify_migration(self) -> bool:
        ...
        try:
            ...
            # レコード数が一致するか確認
            if (
                sqlite_items_count == postgres_items_count
                and sqlite_changes_count == postgres_changes_count
                and sqlite_runs_count == postgres_runs_count
            ):
    ...
    def run_migration(self) -> bool:
        ...
        try:
            ...
            logger.info(
                f"Migrated: {items_count} items, {changes_count} changes, {runs_count} runs"
            )
