...
items_fetched_total = Counter(
    'rakuten_items_fetched_total', 
    'Total number of items fetched from Rakuten'
)
...
run_duration_seconds = Histogram(
    'rakuten_run_duration_seconds', 
    'Duration of monitoring run in seconds'
)

fetch_duration_seconds = Histogram(
    'rakuten_fetch_duration_seconds',
    'Duration of page fetch in seconds',
    ['method']
)
...
last_run_status = Gauge(
    'rakuten_last_run_status', 
    'Status of last monitoring run (1=success, 0=failure)'
)

last_run_timestamp = Gauge(
    'rakuten_last_run_timestamp', 
